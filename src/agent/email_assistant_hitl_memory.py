...
from agent.tools.default.prompt_templates import HITL_MEMORY_TOOLS_PROMPT
from agent.prompts import triage_system_prompt, triage_user_prompt, agent_system_prompt_hitl_memory, default_triage_instructions, default_background, default_response_preferences, default_cal_preferences, MEMORY_UPDATE_INSTRUCTIONS, MEMORY_UPDATE_INSTRUCTIONS_REINFORCEMENT
from agent.schemas import State, RouterSchema, StateInput, UserPreferences
from agent.utils import parse_email, format_for_display, format_email_markdown
...
llm = ChatGoogleGenerativeAI(
    model="gemini-2.5-flash",  # or gemini-1.5-flash for faster
...
def triage_interrupt_handler(state: State, store: BaseStore) -> Command[Literal["response_agent", "__end__"]]:
    ...
    print("DEBUG interrupt response:", response)
